...
**検証結果：** 2026年9月13日、クリーンなGitHub Actionsランナー上で、Isabelle2025-2のビルドとLean 4.33.0のビルド・監査の両方が、Leanの合流性証明を含むコミット`52881ab`で成功しました。検証した正確なコミットとログは、[検証記録](docs/verification.md)を参照してください。
